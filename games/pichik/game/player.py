import arcade
from game.settings import GROUND_Y, PITCH_FLOOR,PITCH_CEILING, SMOOTHING_ALPHA, AIR_Y, RESPONSE_FACTOR


class PlayerCharacter(arcade.Sprite):
    def __init__(self, scale=0.15):
        super().__init__()
        self.textures = [arcade.load_texture(f"games/pichik/components/{i}_bird.png") for i in range(1, 7)]
