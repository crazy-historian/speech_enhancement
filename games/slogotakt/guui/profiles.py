...
PROFILES_FILE = Path("games/slogotakt/components/profiles_slogotakt.json")
...
def save_profiles(data: dict):
    _ensure_dir()
    PROFILES_FILE.write_text(json.dumps(data, ensure_ascii=False, indent=4), encoding="utf-8")
