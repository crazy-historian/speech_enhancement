# games/slogotakt/gui/qt_task_selector.py
...
def select_task_for_profile(profile_name: str) -> Optional[dict]:
    """
    Модальный выбор без dlg.exec(): ручной цикл processEvents()
    — устойчиво работает вместе с arcade/pyglet.
    Возвращает выбранный task (dict) или None.
    """
    created = False
