...
from guislogi import SyllableConfigWindow  # имя файла, где находится GUI
from slogi import VoiceArcadeGame, analyze_voice  # имя файла, где игра

def load_config():
    config_path = Path("profiles/syllable_config.json")
