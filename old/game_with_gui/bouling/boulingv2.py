...
class VoiceBowlingGame(arcade.Window):
    ...
    def setup(self):
        ...
        self.speech_task = SpeechTask("МА", center_x=400, center_y=100)
    ...
    def on_draw(self):
        ...
        self.player.draw()
        #self.speech_task.draw()
        arcade.draw_text("МА", 450, 60, arcade.color.BLUE_GRAY, 60, bold=True, font_name="Courier New")
